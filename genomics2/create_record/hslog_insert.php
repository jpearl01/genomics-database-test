...
'$_POST[CollabCode]', '$_POST[CoInstCode]', '$_POST[CoDegree]', '$_POST[CoPrefix]', '$_POST[CoFirstName]', '$_POST[CoMiddleName]', '$_POST[CoLastName]', '$_POST[CoSuffix]',
'$_POST[InstCode]', '$_POST[InstName]', '$_POST[InstCity]', '$_POST[InstState]', '$_POST[InstCountry]', '$_POST[InstPhone]', '$_POST[InstZipCode]',
